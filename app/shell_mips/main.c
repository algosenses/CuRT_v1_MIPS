...
static thread_struct output1_thread, output2_thread;
static tid_t output1_tid, output2_tid;

static void output1(void *pdata)
{
    init_os_timer();
...
static void output2(void *pdata)
{
    while (1) {
        printf("&");
//        thread_delay(3);
...
int main()
{
    ...
    output1_tid = thread_create(&output1_thread,
            &thread_stk[3][THREAD_STACK_SIZE-1],
            output1,
            "output1",
            5,
    ...
    output2_tid = thread_create(&output2_thread,
            &thread_stk[4][THREAD_STACK_SIZE-1],
            output2,
            "output2",
            5,
...
static void print_statistics(void *pdata)
{
    while (1) {
        ...
        printf("**************************************************\n");
        printf("print_statistics suspend!\n");
...
static void print_thread_info(void *pdata)
{
    ...
    while (1) {
        ...
        printf("print_thread_info suspend!\n");
        thread_suspend(current_thread->tid);
    }
}
